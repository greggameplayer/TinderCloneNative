...
export default function Frame12({navigation}: { navigation: any }) {
    ...
    return (
        <View style={{
            flex: 1, backgroundColor: "#f2f2f2", flexDirection: "column",
            flexWrap: "wrap", paddingTop: insets.top
        }}>

            <View style={styles.header}>
                {/* @ts-ignore */}
                <Icon type="font-awesome-5" name="fire" onPress={() => navigation.navigate('Frame11')}/>
                {/* @ts-ignore */}
                <Icon type="font-awesome-5" name="star" solid/>
                {/* @ts-ignore */}
                <Icon type="font-awesome-5" name="comment" solid onPress={() => navigation.navigate('Frame20')}/>
                {/* @ts-ignore */}
                <Icon type="font-awesome-5" name="user" solid color="#FD3178"/>
            </View>
            ...
            <View style={styles.alignRow}>
                <View style={styles.logo}>
                    {/* @ts-ignore */}
                    <Icon type="font-awesome-5" name="cog" color="#B3BEC4"
    onPress={() => navigation.navigate('Frame13')}/>
                </View>
                <View>
                    {/* @ts-ignore */}
                    <Icon type="font-awesome-5" name="camera" color="#FD3178"/>
                </View>
                <View style={styles.logo2}>
                    {/* @ts-ignore */}
                    <Icon type="font-awesome-5" name="shield-alt" color="#B3BEC4"/>
                </View>
            </View>
            ...
            <View style={styles.tipsContainer}>
                <View>
                    <LinearGradient colors={['#FD3178', '#FF7059']} style={styles.gradient}>
                        ...
                        {/* @ts-ignore */}
                        <Icon type="font-awesome-5" name="plus-circle" style={styles.logoBis} color={"#FFFFFF"}/>
                    </LinearGradient>
                </View>
            </View>
            ...
            <View style={styles.positionCenterBis}>
                {/* @ts-ignore */}
                <Icon type="font-awesome-5" name="heart" style={styles.littleMargin} color={"#41b2db"}/>
                <View>
            ...
            <View style={styles.footer}>
                <CustomButton action={() => navigation.navigate('Frame10')} type={"outlined"}
                              colors={["white", "white"]} width={200} height={40} textColor="#FD3178"
