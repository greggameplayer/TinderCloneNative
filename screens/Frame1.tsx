...
export default function FrameRegistration({navigation}: {navigation: any}) {
    return (
        <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <CustomButton action={() => navigation.navigate('Frame1')} type={'outlined'} title={"CONNEXION AVEC APPLE"} width={300} height={70} />

            <CustomButton action={() => navigation.navigate('Frame1')} type={'outlined'} title={"SE CONNECTER AVEC FACEBOOK"} width={300} height={70} />
            <CustomButton action={() => navigation.navigate('Frame1')} type={'outlined'} title={"CONNEXION AVEC UN NUMERO DE TELEPHONE"} width={300} height={70} />
